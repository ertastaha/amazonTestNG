			...
			switch (browser) {
				...
				case "remote_chrome":
					try {
						...
						DriverPool.set(new RemoteWebDriver(new URL("http://52.205.237.157:4444"), chromeOptions));
					} catch (Exception e) {
						e.printStackTrace();
					}
					break;
				case "remote_firefox":
					try {
						...
						DriverPool.set(new RemoteWebDriver(new URL("http://52.205.237.157:4444"), firefoxOptions));
					} catch (Exception e) {
						e.printStackTrace();
					}
					break;
